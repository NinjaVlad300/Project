...
public class IndViewController {
    private final Calculator calculator = new Calculator();
    @FXML
    private BarChart<String, Double> indChart;
    @FXML
    ...
    private void fillChart() {
        ...
        double[] doubles = calculator.calcArrayIdo();
        ...
        indChart.getData().addAll(series);
